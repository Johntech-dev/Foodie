...
<footer className="footer items-center p-4 text-neutral-content">
  <aside className="items-center grid-flow-col">
   <img src='logo.png' />
    <p className='text-secondary'>Copyright © 2024 - All right reserved</p>
  </aside> 
  <nav className="grid-flow-col text-secondary gap-4 md:place-self-center md:justify-self-end">
